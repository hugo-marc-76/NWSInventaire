...
namespace NWSInventaire.Server.Migrations
{
    ...
    [Migration("20230226191142_AddFinalReminderToMaterial")]
    partial class AddFinalReminderToMaterial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NWSInventaire.Shared.Models.Material", b =>
                {
                    ...
                    b.Property<bool>("FinalReminder")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("LastReminder")
                        .HasColumnType("timestamp without time zone");

                    b.Property<Guid>("LinkAllMaterial")
                        .HasColumnType("uuid");
